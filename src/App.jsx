...
function tabLabel(tab) {
  if (tab.rootId === rootId) return 'Esquema general';
  ...
  return (
    <main className="app">
      ...
      <header className="bar">
        <button type="button" className="bar__home" onClick={goHome} aria-label="Volver al esquema general" title="Volver al esquema general">
